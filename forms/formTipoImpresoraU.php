...
if(isset($_SESSION['nombre'])) {
    ...
    $consulta = "SELECT * FROM ".$tablaDeMysql." WHERE id_tipo_impresora LIKE '".$_GET['id']."'";
                    ...
                    <div class="col-lg-12">
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                <div class="form">
                                    <form class="form-validate form-horizontal " id="register_form" method="post" action="../controllers/updateTipoImpresora.php?a=update&id=<?php echo $_GET['id'] ?>">
