                        ...
                        <div class="col-lg-12">
                            <section class="panel">
                                <header class="panel-heading">
                                    Agregar software sin licencia para equipo de: <?php echo $usuario ?>
                                </header>
                                <div class="panel-body">
                                    <div class="form">
                                        <form class="form-validate form-horizontal " id="register_form" method="post"
                                              action="../controllers/updateSoftwareNLicencia.php?a=add&id=<?php echo $_GET['id'] ?>&id2=<?php echo $_GET['id2'] ?>">
