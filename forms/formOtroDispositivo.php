            ...
            <div class="panel-body">
                <div class="form">
                    <form class="form-validate form-horizontal " id="register_form" method="post"
                          action="../controllers/updateOtroDispositivo.php?a=add&id=<?php echo $_GET['id'] ?>">
                        ...
                        <div class="form-group ">
                            <label for="fullname" class="control-label col-lg-2">Capacidad <span
                                    class="required">*</span></label>
                        ...
                        <div class="form-group ">
                            <label for="fullname" class="control-label col-lg-2">Calificacion <span
                                    class="required">*</span></label>
